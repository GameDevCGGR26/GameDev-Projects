...
CharacterSelectState2 = Class{__includes = BaseState}

charNum = 1
function CharacterSelectState2:init()
    self.currentChar = 1
...
function CharacterSelectState2:update(dt)
    if self.currentChar == 1 then
        charNum = 1
    elseif self.currentChar == 2 then
        charNum = 2
...
function CharacterSelectState2:render()
