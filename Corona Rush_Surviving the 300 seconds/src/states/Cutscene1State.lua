Cutscene1State = Class{__includes = BaseState}

require 'src/cutscenes/cutscene1'


function Cutscene1State:init()
...
function Cutscene1State:enter()
    next_text = 1
    x = 1
end

function Cutscene1State:loadAssets()
...
function Cutscene1State:update(dt)
...
function Cutscene1State:render()
    ...
    love.graphics.printf("Press s to skip", 20, 680,
        WINDOW_WIDTH, 'left')

        love.graphics.printf("Press x for previous", 10, 680,
            WINDOW_WIDTH, 'center')

    love.graphics.printf("Press Spacebar to continue", -20, 680,
        WINDOW_WIDTH, 'right')


end

function Cutscene1State:setState()
    if next_text == 1 then
	    self.state = "news"
