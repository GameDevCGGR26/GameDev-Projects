...
function StateMachine:change(stateName, enterParams)
    assert(self.states[stateName]) -- state mus exist!
    self.current:exit()
...
function StateMachine:beginContact(a, b, collision)
	self.current:beginContact(a, b, collision)
end

function StateMachine:endContact(a, b, collision)
	self.current:endContact(a, b, collision)
end
